...
public class HelloController {
	...
	public String path2(@RequestBody PutBody bodyPut){
		// PutBody is a POJO class for this put request body which only contains a key called bodyPut
		// String boot will convert the JSON to POJO for us, such that we can get the request body
